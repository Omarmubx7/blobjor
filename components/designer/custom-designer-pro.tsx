...
const PRODUCTS = {
  hoodie: {
    ...
    colors: [
      ...
      { id: 'blue', hex: '#3b82f6', name: 'أزرق', image: '/images/hoodie-blue.png' },
      { id: 'green', hex: '#22c55e', name: 'أخضر', image: '/images/hoodie-green.png' }
    ],
    sizes: ['22', '26', '30', '34', '36', 'XS', 'S', 'M', 'L', 'XL', '2XL', '3XL', '4XL', '5XL'],
